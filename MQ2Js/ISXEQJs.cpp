...
// The mandatory pre-setup function.  Our name is "ISXEQJs", and the class is ISXEQJs.
...
bool ISXEQJs::Initialize(ISInterface *p_ISInterface)
{
	...
	WriteChatf("ISXEQJs Loaded");
	return true;
}

// shutdown sequence
void ISXEQJs::Shutdown()
{
	// save settings, if you changed them and want to save them now.  You should normally save
	// changes immediately.
	//pISInterface->ExportSet(ISXEQJsXML,XMLFileName);

	pISInterface->UnloadSet(ISXEQJsXML);
...
void ISXEQJs::RegisterAliases()
{
	// add any aliases
}

void ISXEQJs::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQJs::UnRegisterCommands()
{
	// remove commands
	//    pISInterface->RemoveCommand("MyCommand");
}
void ISXEQJs::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQJs::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQJs::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
	//    pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQJs::UnRegisterServices()
{
	// shutdown our own services
	//    if (hISXEQJsService)
	//        pISInterface->ShutdownService(this,hISXEQJsService);
}

void ISXEQJs::LoadSettings()
{
	bool bChanged = false;

	// open the settings file, and store the ID number in ISXEQJsXML
	ISXEQJsXML = pISInterface->OpenSettings(XMLFileName);
	...
	Any set can be referred to by its ID.  The base set is stored in ISXEQJsXML.  Note that the settings
	...
	*/
	...
	if (unsigned int GeneralGUID = pISInterface->FindSet(ISXEQJsXML, "General"))
	{
