...
{
    DebugSpewAlways("MQ2TangSM::OnZoned()");
}
...
{
    DebugSpewAlways("MQ2TangSM::OnCleanUI()");
...
{
    DebugSpewAlways("MQ2TangSM::OnReloadUI()");
...
PLUGIN_API VOID OnDrawHUD(VOID)
{
    ...
    //DebugSpewAlways("MQ2TangSM::OnDrawHUD()");
}
...
{
    DebugSpewAlways("MQ2TangSM::OnWriteChatColor(%s)",Line);
    return 0;
}
...
{
    DebugSpewAlways("MQ2TangSM::OnIncomingChat(%s)",Line);
    return 0;
}
...
{
    DebugSpewAlways("MQ2TangSM::OnAddSpawn(%s)",pNewSpawn->Name);
}
...
{
    DebugSpewAlways("MQ2TangSM::OnRemoveSpawn(%s)",pSpawn->Name);
}
...
{
    DebugSpewAlways("MQ2TangSM::OnAddGroundItem(%d)",pNewGroundItem->DropID);
}
...
{
    DebugSpewAlways("MQ2TangSM::Zoned");
}